...
// source: ai_robot.proto

#ifndef PROTOBUF_ai_5frobot_2eproto__INCLUDED
#define PROTOBUF_ai_5frobot_2eproto__INCLUDED
...
void protobuf_AddDesc_ai_5frobot_2eproto();
void protobuf_AssignDesc_ai_5frobot_2eproto();
void protobuf_ShutdownFile_ai_5frobot_2eproto();
...
class PathPlanningPackage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:PathPlanningPackage) */ {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_ai_5frobot_2eproto();
  friend void protobuf_AssignDesc_ai_5frobot_2eproto();
  friend void protobuf_ShutdownFile_ai_5frobot_2eproto();
...
class AIRobotPackage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:AIRobotPackage) */ {
 public:
  ...
  int sensorial_info_size() const;
  void clear_sensorial_info();
  static const int kSensorialInfoFieldNumber = 7;
  const ::std::string& sensorial_info(int index) const;
  ::std::string* mutable_sensorial_info(int index);
  void set_sensorial_info(int index, const ::std::string& value);
  void set_sensorial_info(int index, const char* value);
  void set_sensorial_info(int index, const char* value, size_t size);
  ::std::string* add_sensorial_info();
  void add_sensorial_info(const ::std::string& value);
  void add_sensorial_info(const char* value);
  void add_sensorial_info(const char* value, size_t size);
  const ::google::protobuf::RepeatedPtrField< ::std::string>& sensorial_info() const;
  ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_sensorial_info();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::std::string> sensorial_info_;
  float target_x_;
  float target_y_;
...
#endif  // PROTOBUF_ai_5frobot_2eproto__INCLUDED
