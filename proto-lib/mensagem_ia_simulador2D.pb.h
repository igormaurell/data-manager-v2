...
class PacotePathPlanning : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:PacotePathPlanning) */ {
 public:
  PacotePathPlanning();
  ...
  inline PacotePathPlanning* New() const { return New(NULL); }

  PacotePathPlanning* New(::google::protobuf::Arena* arena) const;
  ...
  void InternalSwap(PacotePathPlanning* other);
  private:
...
class PacoteRoboIA : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:PacoteRoboIA) */ {
 public:
  PacoteRoboIA();
  ...
  inline PacoteRoboIA* New() const { return New(NULL); }

  PacoteRoboIA* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(PacoteRoboIA* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  bool has_tatica() const;
  void clear_tatica();
  static const int kTaticaFieldNumber = 8;
  const ::std::string& tatica() const;
  void set_tatica(const ::std::string& value);
  void set_tatica(const char* value);
  void set_tatica(const char* value, size_t size);
  ::std::string* mutable_tatica();
  ::std::string* release_tatica();
  void set_allocated_tatica(::std::string* tatica);

  // repeated string informacoesSensorias = 9;
  int informacoessensorias_size() const;
  void clear_informacoessensorias();
  static const int kInformacoesSensoriasFieldNumber = 9;
  const ::std::string& informacoessensorias(int index) const;
  ::std::string* mutable_informacoessensorias(int index);
  void set_informacoessensorias(int index, const ::std::string& value);
  void set_informacoessensorias(int index, const char* value);
  void set_informacoessensorias(int index, const char* value, size_t size);
  ::std::string* add_informacoessensorias();
  void add_informacoessensorias(const ::std::string& value);
  void add_informacoessensorias(const char* value);
  void add_informacoessensorias(const char* value, size_t size);
  const ::google::protobuf::RepeatedPtrField< ::std::string>& informacoessensorias() const;
  ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_informacoessensorias();

  // optional float alvoX = 10;
  bool has_alvox() const;
  void clear_alvox();
  static const int kAlvoXFieldNumber = 10;
  float alvox() const;
  void set_alvox(float value);

  // optional float alvoY = 11;
  bool has_alvoy() const;
  void clear_alvoy();
  static const int kAlvoYFieldNumber = 11;
  float alvoy() const;
  void set_alvoy(float value);
  ...
  const ::PacotePathPlanning& pathplanning() const;
  ::PacotePathPlanning* mutable_pathplanning();
  ::PacotePathPlanning* release_pathplanning();
  void set_allocated_pathplanning(::PacotePathPlanning* pathplanning);

  // optional float vel_ang = 13;
  bool has_vel_ang() const;
  void clear_vel_ang();
  static const int kVelAngFieldNumber = 13;
  float vel_ang() const;
  void set_vel_ang(float value);

  // optional float chute_baixo = 14;
  bool has_chute_baixo() const;
  void clear_chute_baixo();
  static const int kChuteBaixoFieldNumber = 14;
  float chute_baixo() const;
  void set_chute_baixo(float value);

  // optional float chute_alto = 15;
  bool has_chute_alto() const;
  void clear_chute_alto();
  static const int kChuteAltoFieldNumber = 15;
  float chute_alto() const;
  void set_chute_alto(float value);

  // optional float drible_ligado = 16;
  bool has_drible_ligado() const;
  void clear_drible_ligado();
  static const int kDribleLigadoFieldNumber = 16;
  float drible_ligado() const;
  void set_drible_ligado(float value);
 ...
 private:
  ...
  ::google::protobuf::internal::ArenaStringPtr tatica_;
...
class PacoteIASimulador2D : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:PacoteIASimulador2D) */ {
 public:
  PacoteIASimulador2D();
  ...
  inline PacoteIASimulador2D* New() const { return New(NULL); }

  PacoteIASimulador2D* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(PacoteIASimulador2D* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  static const CorEquipe AMARELO =
    PacoteIASimulador2D_CorEquipe_AMARELO;
  static const CorEquipe AZUL =
    PacoteIASimulador2D_CorEquipe_AZUL;
  ...
  static const LadoCampo ESQUERDO =
    PacoteIASimulador2D_LadoCampo_ESQUERDO;
  static const LadoCampo DIREITO =
    PacoteIASimulador2D_LadoCampo_DIREITO;
  ...
  bool has_jogada() const;
  void clear_jogada();
  static const int kJogadaFieldNumber = 3;
  const ::std::string& jogada() const;
  void set_jogada(const ::std::string& value);
  void set_jogada(const char* value);
  void set_jogada(const char* value, size_t size);
  ::std::string* mutable_jogada();
  ::std::string* release_jogada();
  void set_allocated_jogada(::std::string* jogada);

  // repeated string fatosDoMundo = 4;
  int fatosdomundo_size() const;
  void clear_fatosdomundo();
  static const int kFatosDoMundoFieldNumber = 4;
  const ::std::string& fatosdomundo(int index) const;
  ::std::string* mutable_fatosdomundo(int index);
  void set_fatosdomundo(int index, const ::std::string& value);
  void set_fatosdomundo(int index, const char* value);
  void set_fatosdomundo(int index, const char* value, size_t size);
  ::std::string* add_fatosdomundo();
  void add_fatosdomundo(const ::std::string& value);
  void add_fatosdomundo(const char* value);
  void add_fatosdomundo(const char* value, size_t size);
  const ::google::protobuf::RepeatedPtrField< ::std::string>& fatosdomundo() const;
  ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_fatosdomundo();

  // repeated .PacoteRoboIA robos = 5;
  int robos_size() const;
  void clear_robos();
  static const int kRobosFieldNumber = 5;
  const ::PacoteRoboIA& robos(int index) const;
  ::PacoteRoboIA* mutable_robos(int index);
  ::PacoteRoboIA* add_robos();
  ...
  int robosadv_size() const;
  void clear_robosadv();
  static const int kRobosAdvFieldNumber = 6;
  const ::PacoteRobo& robosadv(int index) const;
  ::PacoteRobo* mutable_robosadv(int index);
  ::PacoteRobo* add_robosadv();
  ...
  ::PacoteIASimulador2D_CorEquipe corequipe() const;
  void set_corequipe(::PacoteIASimulador2D_CorEquipe value);
  ...
  ::PacoteIASimulador2D_LadoCampo ladocampo() const;
  void set_ladocampo(::PacoteIASimulador2D_LadoCampo value);
 ...
 private:
  ...
  ::google::protobuf::internal::ArenaStringPtr jogada_;
...
inline void PacoteRoboIA::set_allocated_skill(::std::string* skill) {
  if (skill != NULL) {
    set_has_skill();
  } else {
    clear_has_skill();
...
inline void PacoteRoboIA::set_allocated_tatica(::std::string* tatica) {
  if (tatica != NULL) {
    set_has_tatica();
  } else {
    clear_has_tatica();
...
inline void PacoteRoboIA::set_allocated_pathplanning(::PacotePathPlanning* pathplanning) {
...
inline void PacoteIASimulador2D::set_allocated_bola(::PacoteBola* bola) {
  delete bola_;
  bola_ = bola;
  if (bola) {
    set_has_bola();
...
inline void PacoteIASimulador2D::set_allocated_dadosestados(::SSL_Referee* dadosestados) {
...
inline void PacoteIASimulador2D::set_allocated_jogada(::std::string* jogada) {
  if (jogada != NULL) {
    set_has_jogada();
  } else {
    clear_has_jogada();
...
template <> struct is_proto_enum< ::PacoteIASimulador2D_CorEquipe> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::PacoteIASimulador2D_CorEquipe>() {
  return ::PacoteIASimulador2D_CorEquipe_descriptor();
}
template <> struct is_proto_enum< ::PacoteIASimulador2D_LadoCampo> : ::google::protobuf::internal::true_type {};
template <>
