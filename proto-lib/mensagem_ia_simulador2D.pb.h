...
class PacoteRoboIA : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_tatica(::std::string* tatica);
  ...
  inline void set_allocated_pathplanning(::PacotePathPlanning* pathplanning);
...
class PacoteIASimulador2D : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_bola(::PacoteBola* bola);
  ...
  inline void set_allocated_jogada(::std::string* jogada);
