...
class BallPackage : public ::google::protobuf::Message {
 public:
  BallPackage();
  virtual ~BallPackage();
...
class RobotPackage : public ::google::protobuf::Message {
 public:
  RobotPackage();
...
class VisionPackage : public ::google::protobuf::Message {
 public:
  VisionPackage();
  ...
  inline const ::RobotPackage& team(int index) const;
  inline ::RobotPackage* mutable_team(int index);
  inline ::RobotPackage* add_team();
