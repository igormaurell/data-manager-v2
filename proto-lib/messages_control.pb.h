...
class ControlPackage : public ::google::protobuf::Message {
 public:
  ControlPackage();
  ...
  static const FieldSide Left = ControlPackage_FieldSide_Left;
  static const FieldSide Right = ControlPackage_FieldSide_Right;
  ...
  static const TeamColor Yellow = ControlPackage_TeamColor_Yellow;
  static const TeamColor Blue = ControlPackage_TeamColor_Blue;
  ...
  inline ::ControlPackage_FieldSide field_side() const;
  inline void set_field_side(::ControlPackage_FieldSide value);
  ...
  inline ::ControlPackage_TeamColor team_color() const;
  inline void set_team_color(::ControlPackage_TeamColor value);

  // required int32 id_GK = 3;
  inline bool has_id_gk() const;
  inline void clear_id_gk();
  static const int kIdGKFieldNumber = 3;
  inline ::google::protobuf::int32 id_gk() const;
  inline void set_id_gk(::google::protobuf::int32 value);
